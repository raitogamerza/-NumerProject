...
function CompositeTrapezoidal() {
    ...
    const handleCalculate = () => {
        ...
        const I = (h / 2) * (fValue[0].fxi + fValue[N].fxi + 2 * (sum - fValue[0].fxi - fValue[N].fxi));

        
        let lines = [];
        lines.push(`h = ( ${b} - ${a} ) / ${N} = ${h}`);
        fValue.forEach(
            (item) =>
  ...
  return (
    <div className="p-6">
        <h1 className="text-2xl font-bold items-center mb-4 text-center">Composite Trapezoidal Rule</h1>
