...
function Trapezoidal() {
    ...
    const handleCalculate = () => {
        ...
        let lines = [];
        lines.push(`h = ( ${b} - ${a} ) = ${h}`);
        lines.push(`f(x0 = ${a}) = ${fa.toFixed(4)}`);
        lines.push(`f(x1 = ${b}) = ${fb.toFixed(4)}`);
        lines.push(`I = ( ${h} / 2 ) * ( ${fa.toFixed(4)} + ${fb.toFixed(4)} ) = ${I.toFixed(6)}`);
  ...
  return (
    <div className="p-6">
        <h1 className="text-2xl font-bold items-center mb-4 text-center">Trapezoidal Rule</h1>
