...
import {luDecompositionMethod} from './Linear algebra equation/LUDecomposition';
...
function LUDecomposition() {
  ...
  const handleCalculate = () => {
    try{
      const { detA, X, singular } = luDecompositionMethod(A, B, eps);
      if (singular) {
  ...
  return (
    <div className='w-full flex justify-center'>
      <div className='w-full max-w-7xl p-4'>
        <h1 className = "text-2xl font-bold mb-4 text-center">LU Decomposition</h1>
